class HomeController < ApplicationController
  def top
    @products = [
      ...
      {name: "BTNG", id_name: "btng-product", img_url: "/products-img/btng-img2.png", date: "2019.07.06"},
    ...
    @hide_products = [
      ...
      {name: "BTNG", img_url: "/products-img/btng-img2.png", date: "2019.07.06", url: "http://okaryo-tr.com/btn_generator", hide_id: "hide-btng", close_id:"close-btng" , framework: "", comment: "Button Generator, \"BTNG\" for short. You can try making a button at will!"},
