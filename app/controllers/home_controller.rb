class HomeController < ApplicationController
  def top
    ...
    @hide_products = [
      ...
      {name: "BTNG", img_url: "/products-img/btng-img.png", date: "2019.07.06", url: "http://okaryo-tr.com/btn-generator", hide_id: "hide-btng", close_id:"close-btng" , framework: "", comment: "Button Generator, \"BTNG\" for short. You can try making a button at will!"},
